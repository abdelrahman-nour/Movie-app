...
export default function AIChat() {
  ...
  return (
    <>
      ...
      {/* Chat Window */}
      {open && (
        <div className="fixed bottom-24 right-6 z-50 w-[360px] max-w-[calc(100%-32px)] h-[500px] bg-white rounded-2xl shadow-2xl border flex flex-col overflow-hidden">
...
{/* Messages */}
  ...
  <div className="flex justify-start items-center mb-4">
    ...
    {/* Typing Indicator */}
    <div className="bg-white border shadow-sm px-4 py-2.5 rounded-2xl rounded-bl-sm">
      <div className="flex items-center gap-2">
        ...
        <div className="flex gap-1">
          ...
          <div className="p-3 border-t bg-white flex gap-2">
            ...
            <button
              onClick={handleSend}
              disabled={loading}
              className="bg-yellow-300 px-4 rounded-xl font-semibold text-sm disabled:opacity-50"
            >
              {loading ? "..." : "Send"}
            </button>
